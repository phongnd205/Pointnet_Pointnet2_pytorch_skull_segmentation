...
class get_model(nn.Module):
    def __init__(self, num_parts, normal_channel=False):
        ...
        self.fp1 = PointNetFeaturePropagation(in_channel=128+self.num_classes+6+additional_channel, mlp=[128, 128, 128])
